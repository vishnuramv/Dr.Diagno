...
export const BASEURL = "https://drdiagno.herokuapp.com";
...
export const diseaseDescription = {
    ...
    "Allergy": {
        ...
        "precaution": ["apply calamine", "cover area with bandage", "Do not itch", "use ice to compress itching"],
    },
    "Hypothyroidism": {
    ...
    "Urinary tract infection": {
        "description": "An infection of the kidney, ureter, bladder, or urethra. Abbreviated UTI. Not everyone with a UTI has symptoms, but common symptoms include a frequent urge to urinate and pain or burning when urinating.",
    ...
    "Hepatitis C": {
        ...
        "precaution": ["Consult nearest hospital", "vaccination", "avoid fatty spicy food", "medication"],
    },
    "Migraine": {
    ...
    "Bronchial Asthma": {
        ...
        "precaution": ["switch to loose clothing", "take deep breaths", "get away from trigger", "seek help"],
    },
    "Alcoholic hepatitis": {
    ...
    "Dengue": {
        ...
        "precaution": ["drink papaya leaf juice", "avoid fatty spicy food", "keep mosquitos away"],
    },
    "Hepatitis D": {
